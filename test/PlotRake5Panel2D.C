...
void PlotRake5Panel2D( const TString &sim, Int_t time, Float_t zoom=2, Int_t Nbins=2, const TString &options="") {
  ...
  if(opt.Contains("hres") && !opt.Contains("pdf")) 
    ...
    C = new TCanvas("C","2D Charge density and Electric field",640,1024);
  else 
    C = new TCanvas("C","2D Charge density and Electric field",1280,2048);
  ...
  PlasmaGlob::SetPaveTextStyle(textLabel[4],12); 
