...
void PlotRake4bPanel2D( const TString &sim, Int_t time, Float_t zoom=2, Int_t Nbins=2, const TString &options="") {
  ...
  hIonProb2D->GetZaxis()->SetTitle("Ionization [%]");
  ...
  // Output file
  TString fOutName = Form("./%s/Plots/Rake4bPanel2D/Rake4bPanel2D",pData->GetPath().c_str());
