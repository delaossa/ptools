...
void PlotRakeBunchJUGENE( const TString &sim, Int_t timestep, const TString &options="") {
  ...
  Float_t dt   = 0.023;
  Int_t ndump  = 300;
  Float_t Time = timestep * dt * ndump;
  ...
  Float_t x1Min = 3306.8;
  Float_t x1Max = 3308.6;
  Float_t x2Min = -0.1;
  Float_t x2Max =  0.1;
  Float_t x3Min = -0.1;
  Float_t x3Max =  0.1;
  ...
  Float_t p1Min =  2200.01;
  Float_t p1Max =  6599.99;
  Float_t p2Min = -5.0;
  Float_t p2Max =  5.0;
  Float_t p3Min = -5.0;
  Float_t p3Max =  5.0;
  ...
  TString filename = Form("%s/DATA/downRampBunch.root",sim.Data());
  cout << filename.Data() << endl;
  
  TFile *file = new TFile(filename.Data(),"READ");
  TTree *tree = (TTree*) file->Get("root");

  const Int_t Nvar = 8;
  Float_t var[Nvar];  
  char varname[Nvar][8] = {{"ene"},{"p1"},{"p2"},{"p3"},{"q"},{"x1"},{"x2"},{"x3"}};
  ...
  Int_t SNbin = 40;
  Float_t x1BinMin = 3306.95;
  Float_t x1BinMax = 3307.9;
  ...
  if(opt.Contains("units")) {
    ...
    cout << Form(" Integrated charge (RAW) = %8.4f n0 * kp^-3",Charge) << endl;
  }
  ...
  TLegend *Leg;
  Leg=new TLegend(0.55,0.70,1 - gPad->GetRightMargin() - 0.02,0.95);
  ...
  fOutName += Form("-%s_%i",sim.Data(),timestep);
