...
def main():
    ...
    for i in range(NP):
        Yall[i,:,0] = Ylist[i][:,0]
        Yall[i,:,1] = Ylist[i][:,1]
        Yall[i,:,2] = Ylist[i][:,2] * np.cos(YPPh0[i])
        Yall[i,:,3] = Ylist[i][:,3] * np.cos(YPPh0[i])
        Yall[i,:,4] = Ylist[i][:,2] * np.sin(YPPh0[i])
        Yall[i,:,5] = Ylist[i][:,3] * np.sin(YPPh0[i])
