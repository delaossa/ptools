...
void PlotChargeFieldIon2D( const TString &sim, Int_t time, Int_t zoom=2, Int_t Nbins=2, const TString &options="") {
  ...
  // Output file
  TString fOutName = Form("./%s/Plots/ChargeFieldIon2D/ChargeFieldIon2D",pData->GetPath().c_str());
  ...
  Float_t factor = 1.0;    
  PGlobals::CanvasAsymPartition(C,3,lMargin,rMargin,bMargin,tMargin,factor);
