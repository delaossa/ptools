...
void PlotChargeFieldPot2D( const TString &sim, Int_t time, Float_t zoom=2, Int_t Nbins=2, const TString &options="") {
  ...
  // Canvas setup
  TCanvas *C = new TCanvas("C","2D Charge density and longitudinal Electric field",800,800);
  ...
  // Output file
  TString fOutName = Form("./%s/Plots/ChargeFieldPot2D/ChargeFieldPot2D",pData->GetPath().c_str());
